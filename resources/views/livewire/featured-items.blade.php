                    ...
                    <article data-aos="fade-up" data-aos-duration="1500"
                        ...
                        @if (
                            ...
                            <video class="absolute inset-0 -z-10 h-full w-full object-cover" autoplay muted loop>
                                <source src="{{ Storage::url($currentItem->file_path) }}" type="video/mp4">
    ...
    {{-- <div>
        @if ($currentItem)
            <article data-aos="fade-up" data-aos-duration="1500"
                ...
                @if ($mimeType === 'video/mp4' || $mimeType === 'video/webm' || $mimeType === 'video/ogg' || $mimeType === 'video/quicktime' || 'video/x-flv')
                    <video class="absolute inset-0 -z-10 h-full w-full object-cover" autoplay muted loop>
                        <source src="{{ Storage::url($currentItem->file_path) }}" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
